...
void Arm_controller_v2_step(void)
{
   ...
   *  Inport: '<Root>/Joint6'
   */
  rtb_TmpSignalConversionAtSFunct[0] = Arm_controller_v2_P.Converttodegrees_Gain
    * Arm_controller_v2_U.Joint1;
  rtb_TmpSignalConversionAtSFunct[1] = Arm_controller_v2_P.Converttodegrees_Gain
    * Arm_controller_v2_U.Joint2;
  rtb_TmpSignalConversionAtSFunct[2] = Arm_controller_v2_P.Converttodegrees_Gain
    * Arm_controller_v2_U.Joint3;
  rtb_TmpSignalConversionAtSFunct[3] = Arm_controller_v2_P.Converttodegrees_Gain
    * Arm_controller_v2_U.Joint4;
  rtb_TmpSignalConversionAtSFunct[4] = Arm_controller_v2_P.Converttodegrees_Gain
    * Arm_controller_v2_U.Joint5;
  rtb_TmpSignalConversionAtSFunct[5] = Arm_controller_v2_P.Converttodegrees_Gain
    ...
    if (rtb_outputs[2] == 1.0) {
      ...
      for (i_0 = 0; i_0 < 4; i_0++) {
        for (i = 0; i < 4; i++) {
          ...
          total_transform[i_0 + (i << 2)] += hb_0[i << 2] * T1_1[i_0];
          total_transform[i_0 + (i << 2)] += hb_0[(i << 2) + 1] * T1_1[i_0 + 4];
          total_transform[i_0 + (i << 2)] += hb_0[(i << 2) + 2] * T1_1[i_0 + 8];
          total_transform[i_0 + (i << 2)] += hb_0[(i << 2) + 3] * T1_1[i_0 + 12];
        }
      }
      ...
      for (i_0 = 0; i_0 < 4; i_0++) {
        j = T1_1[i_0 + 12] + (T1_1[i_0 + 8] * 0.0 + (T1_1[i_0 + 4] * 0.0 +
          T1_1[i_0] * 0.0));
        wrist_2[i_0] = j;
      }
      ...
      /* p2offset = total_transform*[0;-0.072;0;1];%if end effector is rotated by 0 */
      for (i_0 = 0; i_0 < 4; i_0++) {
        j = total_transform[i_0 + 12] + (total_transform[i_0 + 8] * 0.0 +
          (total_transform[i_0 + 4] * 0.072 + total_transform[i_0] * 0.0));
        wrist_2[i_0] = j;
      }
      ...
      /* actual shouler */
      for (i_0 = 0; i_0 < 4; i_0++) {
        j = T1[i_0 + 12] + (T1[i_0 + 8] * 0.135 + (T1[i_0 + 4] * 0.0 + T1[i_0] *
          0.0));
        wrist_2[i_0] = j;
      }
   ...
   */
  /* MATLAB Function 'Arm_controller_v2/setpos': '<S10>:1' */
  ...
  if (rtb_enableflags[4] == 1) {
    ...
    joint_angles_degrees[4] = 90.0;
    joint_angles_degrees[5] = 180.0;

    /* '<S2>:1:11' */
    scan_bottompos1[0] = rtb_TmpSignalConversionAtSFunct[0];
    scan_bottompos1[1] = rtb_TmpSignalConversionAtSFunct[1];
    scan_bottompos1[2] = rtb_TmpSignalConversionAtSFunct[2];
    scan_bottompos1[3] = rtb_TmpSignalConversionAtSFunct[3] - 0.5 * rtb_outputs
      [0];
    ...
    scan_toppos1[3] = 0.5 * rtb_outputs[0] + rtb_TmpSignalConversionAtSFunct[3];
    scan_toppos1[4] = 90.0;
    ...
    if ((rtb_writehome != 0.0) || (j3 != 0.0) || (j4 != 0.0)) {
      ...
      /* '<S2>:1:25' */
      for (i_0 = 0; i_0 < 6; i_0++) {
        rtb_scan_startpos[i_0] = joint_angles_degrees[i_0];
        rtb_scan_bottompos[i_0] = scan_bottompos1[i_0];
        rtb_scan_toppos[i_0] = scan_toppos1[i_0];
      }
    }
  } else {
    /* '<S2>:1:28' */
  ...
  if (rtb_enableflags[5] == 1) {
    ...
    /* UNTITLED Summary of this function goes here */
    /*    Detailed explanation goes here */
    rtb_writehome = rtb_TmpSignalConversionAtSFunct[0];
    Arm_controller_v2_cosd_b(&rtb_writehome);
    wrist_vect_idx_2 = rtb_TmpSignalConversionAtSFunct[0];
    Arm_controller_v2_sind_c(&wrist_vect_idx_2);
    j = rtb_TmpSignalConversionAtSFunct[0];
    Arm_controller_v2_sind_c(&j);
    p1_idx_0 = rtb_TmpSignalConversionAtSFunct[0];
    Arm_controller_v2_cosd_b(&p1_idx_0);
    p1_idx_1 = rtb_TmpSignalConversionAtSFunct[1];
    Arm_controller_v2_cosd_b(&p1_idx_1);
    p1_idx_2 = rtb_TmpSignalConversionAtSFunct[1];
    Arm_controller_v2_sind_c(&p1_idx_2);
    wrist_vect_idx_0 = rtb_TmpSignalConversionAtSFunct[1];
    Arm_controller_v2_cosd_b(&wrist_vect_idx_0);
    wrist_vect_idx_1 = rtb_TmpSignalConversionAtSFunct[1];
    Arm_controller_v2_sind_c(&wrist_vect_idx_1);
    p = rtb_TmpSignalConversionAtSFunct[1];
    Arm_controller_v2_cosd_b(&p);
    q = rtb_TmpSignalConversionAtSFunct[1];
    Arm_controller_v2_sind_c(&q);
    r = rtb_TmpSignalConversionAtSFunct[2];
    Arm_controller_v2_cosd_b(&r);
    s = rtb_TmpSignalConversionAtSFunct[2];
    Arm_controller_v2_sind_c(&s);
    t = rtb_TmpSignalConversionAtSFunct[2];
    Arm_controller_v2_cosd_b(&t);
    u = rtb_TmpSignalConversionAtSFunct[2];
    Arm_controller_v2_sind_c(&u);
    v = rtb_TmpSignalConversionAtSFunct[2];
    Arm_controller_v2_cosd_b(&v);
    w = rtb_TmpSignalConversionAtSFunct[2];
    Arm_controller_v2_sind_c(&w);
    x = rtb_TmpSignalConversionAtSFunct[3];
    Arm_controller_v2_cosd_b(&x);
    y = rtb_TmpSignalConversionAtSFunct[3];
    Arm_controller_v2_sind_c(&y);
    ab = rtb_TmpSignalConversionAtSFunct[3];
    Arm_controller_v2_sind_c(&ab);
    bb = rtb_TmpSignalConversionAtSFunct[3];
    Arm_controller_v2_cosd_b(&bb);
    cb = rtb_TmpSignalConversionAtSFunct[4];
    Arm_controller_v2_cosd_b(&cb);
    db = rtb_TmpSignalConversionAtSFunct[4];
    Arm_controller_v2_sind_c(&db);
    eb = rtb_TmpSignalConversionAtSFunct[4];
    Arm_controller_v2_sind_c(&eb);
    fb = rtb_TmpSignalConversionAtSFunct[4];
    Arm_controller_v2_cosd_b(&fb);
    gb = rtb_TmpSignalConversionAtSFunct[5];
    Arm_controller_v2_cosd_b(&gb);
    hb = rtb_TmpSignalConversionAtSFunct[5];
    Arm_controller_v2_sind_c(&hb);
    ib = rtb_TmpSignalConversionAtSFunct[5];
    Arm_controller_v2_sind_c(&ib);
    jb = rtb_TmpSignalConversionAtSFunct[5];
    ...
    for (i_0 = 0; i_0 < 4; i_0++) {
      for (i = 0; i < 4; i++) {
        T1[i_0 + (i << 2)] = 0.0;
        T1[i_0 + (i << 2)] += l[i << 2] * rtb_writehome_0[i_0];
        T1[i_0 + (i << 2)] += l[(i << 2) + 1] * rtb_writehome_0[i_0 + 4];
        T1[i_0 + (i << 2)] += l[(i << 2) + 2] * rtb_writehome_0[i_0 + 8];
        T1[i_0 + (i << 2)] += l[(i << 2) + 3] * rtb_writehome_0[i_0 + 12];
      }
    }
    ...
    for (i_0 = 0; i_0 < 4; i_0++) {
      for (i = 0; i < 4; i++) {
        rtb_writehome_0[i_0 + (i << 2)] = 0.0;
        rtb_writehome_0[i_0 + (i << 2)] += r_0[i << 2] * T1[i_0];
        rtb_writehome_0[i_0 + (i << 2)] += r_0[(i << 2) + 1] * T1[i_0 + 4];
        rtb_writehome_0[i_0 + (i << 2)] += r_0[(i << 2) + 2] * T1[i_0 + 8];
        rtb_writehome_0[i_0 + (i << 2)] += r_0[(i << 2) + 3] * T1[i_0 + 12];
      }
    }
    ...
    for (i_0 = 0; i_0 < 4; i_0++) {
      for (i = 0; i < 4; i++) {
        T1[i_0 + (i << 2)] = 0.0;
        T1[i_0 + (i << 2)] += x_0[i << 2] * rtb_writehome_0[i_0];
        T1[i_0 + (i << 2)] += x_0[(i << 2) + 1] * rtb_writehome_0[i_0 + 4];
        T1[i_0 + (i << 2)] += x_0[(i << 2) + 2] * rtb_writehome_0[i_0 + 8];
        T1[i_0 + (i << 2)] += x_0[(i << 2) + 3] * rtb_writehome_0[i_0 + 12];
      }
    }
    ...
    for (i_0 = 0; i_0 < 4; i_0++) {
      for (i = 0; i < 4; i++) {
        rtb_writehome_0[i_0 + (i << 2)] = 0.0;
        rtb_writehome_0[i_0 + (i << 2)] += cb_0[i << 2] * T1[i_0];
        rtb_writehome_0[i_0 + (i << 2)] += cb_0[(i << 2) + 1] * T1[i_0 + 4];
        rtb_writehome_0[i_0 + (i << 2)] += cb_0[(i << 2) + 2] * T1[i_0 + 8];
        rtb_writehome_0[i_0 + (i << 2)] += cb_0[(i << 2) + 3] * T1[i_0 + 12];
      }
    }
    ...
    for (i_0 = 0; i_0 < 4; i_0++) {
      for (i = 0; i < 4; i++) {
        total_transform[i_0 + (i << 2)] = 0.0;
        total_transform[i_0 + (i << 2)] += gb_0[i << 2] * rtb_writehome_0[i_0];
        total_transform[i_0 + (i << 2)] += gb_0[(i << 2) + 1] *
          rtb_writehome_0[i_0 + 4];
        total_transform[i_0 + (i << 2)] += gb_0[(i << 2) + 2] *
          rtb_writehome_0[i_0 + 8];
        total_transform[i_0 + (i << 2)] += gb_0[(i << 2) + 3] *
          rtb_writehome_0[i_0 + 12];
      }
    }
    ...
    /* %need to test */
    if (rtb_TmpSignalConversionAtSFunct[0] > 90.0) {
      /* '<S5>:1:21' */
      /* '<S5>:1:22' */
      joint_angles_degrees[0] = rtb_TmpSignalConversionAtSFunct[0];
      joint_angles_degrees[1] = rtb_TmpSignalConversionAtSFunct[1];
      joint_angles_degrees[2] = rtb_TmpSignalConversionAtSFunct[2];
      joint_angles_degrees[3] = rtb_TmpSignalConversionAtSFunct[3] - j3;
      joint_angles_degrees[4] = rtb_writehome - 90.0;
      joint_angles_degrees[5] = 180.0;

      /* need to consider that arm might be rotated */
    } else {
      /* '<S5>:1:24' */
      joint_angles_degrees[0] = rtb_TmpSignalConversionAtSFunct[0];
      joint_angles_degrees[1] = rtb_TmpSignalConversionAtSFunct[1];
    ...
    if (rtb_writehome == 0.0) {
      ...
      /* '<S5>:1:33' */
      for (i_0 = 0; i_0 < 6; i_0++) {
        rtb_jointangles_a[i_0] = joint_angles_degrees[i_0];
      }
    } else {
      /* '<S5>:1:35' */
      status_movecam2 = -1;
  ...
  if (rtb_enableflags[6] == 1) {
    ...
    if (wrist_vect_idx_2 == 0.0) {
      ...
      for (collision_flag = 0; collision_flag < (int32_T)wrist_vect_idx_2;
        ...
        for (i = 0; i < 6; i++) {
          /* '<S6>:1:38' */
          if (q_sols[(i << 3) + collision_flag] > 180.0) {
            /* '<S6>:1:39' */
            /* '<S6>:1:40' */
            q_sols[collision_flag + (i << 3)] -= 360.0;
          }
      ...
      for (collision_flag = 0; collision_flag < (int32_T)wrist_vect_idx_2;
        ...
        /* '<S6>:1:46' */
        for (i_0 = 0; i_0 < 6; i_0++) {
          scan_bottompos1[i_0] = q_sols[(i_0 << 3) + collision_flag];
        }
      ...
      for (collision_flag = 0; collision_flag < (int32_T)wrist_vect_idx_2;
        ...
        if (checksol[collision_flag] == 0) {
          ...
          /* '<S6>:1:77' */
          j4 = fabs(q_sols[collision_flag] - rtb_TmpSignalConversionAtSFunct[0])
            * 10.0;
          ...
          for (i = 0; i < 5; i++) {
            ...
            /* '<S6>:1:80' */
            /* '<S6>:1:81' */
            j4 += fabs(q_sols[((i + 1) << 3) + collision_flag] -
                       rtb_TmpSignalConversionAtSFunct[i + 1]);
      ...
      if ((i == 0) && (collision_flag == 0)) {
        /* '<S6>:1:107' */
        /* arm in normal configuration to normal */
        /* '<S6>:1:108' */
        rtb_wp1_k[0] = rtb_TmpSignalConversionAtSFunct[0];
        rtb_wp1_k[1] = rtb_TmpSignalConversionAtSFunct[1];
        rtb_wp1_k[2] = rtb_TmpSignalConversionAtSFunct[2];
        rtb_wp1_k[3] = rtb_TmpSignalConversionAtSFunct[3];
        rtb_wp1_k[4] = 90.0;
        rtb_wp1_k[5] = rtb_TmpSignalConversionAtSFunct[5];
        ...
        /* '<S6>:1:114' */
        rtb_wp3_e[0] = q_sols[(int32_T)j3 - 1];
        rtb_wp3_e[1] = q_sols[(int32_T)j3 + 7];
        rtb_wp3_e[2] = q_sols[(int32_T)j3 + 15];
        rtb_wp3_e[3] = q_sols[(int32_T)j3 + 23];
        rtb_wp3_e[4] = q_sols[(int32_T)j3 + 31];
        rtb_wp3_e[5] = q_sols[(int32_T)j3 + 39];
        if ((Arm_controlle_check_collision_k(rtb_wp2_o) != 0.0) ||
            (Arm_controlle_check_collision_k(rtb_wp3_e) != 0.0)) {
          /* '<S6>:1:116' */
          status_flag = -1;
        ...
        /* '<S6>:1:132' */
        rtb_wp4_a[0] = q_sols[(int32_T)j3 - 1];
        rtb_wp4_a[1] = q_sols[(int32_T)j3 + 7];
        rtb_wp4_a[2] = q_sols[(int32_T)j3 + 15];
        rtb_wp4_a[3] = q_sols[(int32_T)j3 + 23];
        rtb_wp4_a[4] = -90.0;
        rtb_wp4_a[5] = q_sols[(int32_T)j3 + 39];

        /* wp4(5) = -90; */
        /* '<S6>:1:135' */
        rtb_wp5_b[0] = q_sols[(int32_T)j3 - 1];
        rtb_wp5_b[1] = q_sols[(int32_T)j3 + 7];
        rtb_wp5_b[2] = q_sols[(int32_T)j3 + 15];
        rtb_wp5_b[3] = q_sols[(int32_T)j3 + 23];
        rtb_wp5_b[4] = q_sols[(int32_T)j3 + 31];
        rtb_wp5_b[5] = q_sols[(int32_T)j3 + 39];
        if ((Arm_controlle_check_collision_k(b_0) != 0.0) ||
            (Arm_controlle_check_collision_k(c) != 0.0) ||
            (Arm_controlle_check_collision_k(rtb_wp4_a) != 0.0) ||
            (Arm_controlle_check_collision_k(rtb_wp5_b) != 0.0)) {
          /* '<S6>:1:138' */
          status_flag = -1;
      ...
      /* need to check collision of all waypoints before moving */
    }
  }
  ...
  if (rtb_statusflag_setpos != 1) {
    ...
    if (rtb_portoutput == 1) {
      ...
      for (i = 0; i < 6; i++) {
        ...
        scan_bottompos1[i] = 0.017453292519943295 * rtb_scan_toppos[i];
      }
      ...
      for (i = 0; i < 6; i++) {
        ...
        scan_bottompos1[i] = 0.017453292519943295 * rtb_wp3_e[i];
        scan_toppos1[i] = 0.017453292519943295 * rtb_wp4_a[i];
        joint_angles_degrees[i] = 0.017453292519943295 * rtb_wp5_b[i];
      }
  ...
  for (i = 0; i < 6; i++) {
    ...
    /* Outport: '<Root>/WP3' */
    Arm_controller_v2_Y.WP3[i] = scan_bottompos1[i];

    /* Outport: '<Root>/WP4' */
    Arm_controller_v2_Y.WP4[i] = scan_toppos1[i];

    /* Outport: '<Root>/WP5' */
    Arm_controller_v2_Y.WP5[i] = joint_angles_degrees[i];
