...
{
    public:
        impl_( const partition::extents_type& extents, const Eigen::Vector3d& resolution, std::size_t min_points_per_voxel = 1 )
...
partition::partition( const partition::extents_type& extents, const Eigen::Vector3d& resolution, std::size_t min_points_per_voxel )
...
const boost::optional< comma::uint32 >& partition::insert( const Eigen::Vector3d& point ) { return pimpl_->insert( point ); }
