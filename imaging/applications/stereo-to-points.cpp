...
int main( int argc, char** argv )
{
    try
    {
        ...
        description.add( comma::csv::program_options::description( "t,x,y,z,r,g,b" ) );
        ...
        snark::imaging::stereo stereoPipeline( leftParameters, rightParameters, left.cols, left.rows, csv );
