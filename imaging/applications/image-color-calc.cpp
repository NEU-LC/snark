...
namespace {
    ...
    void usage( bool verbose = false )
    {
        ...
        std::cerr << std::endl;
        std::cerr << "        usage: cat input.csv | image-color-calc --from <colorspace>[,<type>] --to <colorspace>[,<type>]" << std::endl;
        std::cerr << std::endl;
        ...
        std::cerr << "            ub,0-255: todo" << std::endl;
        std::cerr << "            ..." << std::endl;
        std::cerr << "            f,0-1: todo" << std::endl;
        std::cerr << std::endl;
        ...
        std::cerr << "        --from=[<colorspace>[,<range>]]; input colorspace and format, optional, alternatively can be inferred from fields" << std::endl;
        ...
        std::cerr << "        --input-format=[<format>]; explicitly specify the expected precision and range of input values" << std::endl;
